...
class StockController extends Controller
{
    public function index()
    {
        ...
        return view ('layouts.stock', compact('productos', 'categorias'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            return redirect()->route('stock.index')->withErrors($validator)->withInput()->with('errorC','Error al crear el producto revise e intente nuevamente');
        }
        ...
        return redirect()->route('stock.index')->with('successC', 'Producto creado con éxito');
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect()->route('stock.index', $id)->withErrors($validator)->withInput()->with('error','Error al actualizar el producto revise e intente nuevamente');
        ...
        return redirect()->route('stock.index')->with('success', 'Producto actualizado con éxito');
    }
}
