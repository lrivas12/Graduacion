...
<head>
    ...
    <style>
        ...
        body {
            ...
            /* Borde sólido de 2 píxeles con color azul (#007BFF) */
            padding: 10px;
        ...
        .data {
            flex: 1;
            /* El div de datos ocupará el espacio restante */
            /* Alinea el div "data" a la izquierda */
            margin-right: 10px;
            /* Agrega un margen a la derecha para separarlo del div "logo" */
...
<body>
    @php
        ...
        $imagenEmpresa = null;
        // si ya tenemos definida la imagen de la empresa, la usamos, sino no se usa nada, evitando asi cualquier error relacionado con uso de imagenes, permisos, etc.
