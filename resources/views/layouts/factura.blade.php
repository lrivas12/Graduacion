    ...
    <div class="modal-dialog">
      <div class="modal-content d-flex align-items-center" style="max-width: 100%; height: auto;">
        ...
        <div class="modal-body">
            <img src="{{asset('/vendor/adminlte/dist/img/AyudaFactura.jpg')}}" class="img-fluid" alt="Ayuda Factura" style="max-width: 1000px; height: auto;">
        </div>
...
<section class="sectionT2">
    <div class="header">
        <h3><i class="fas fa-money-bill-wave-alt"></i> Generar de Recibo </h3>
    </div>
</section>
<div class="card">
    <div class="card-body">
