...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'apellidousuario' => 'Apellido de Usuario',
        'estadousuario' => 'Estado del Usuario',
        'cedulausuario' => 'Cédula del Usuario',
        'contactousuario' => 'Contacto del Usuario',
        'rolusuario' => 'Rol del Usuario',
        'email' => 'Dirección de Correo Electrónico',
        'username' => 'Usuario de acceso al sistema',
        'password' => 'Contraseña',
        'photo_path' => 'Foto de Perfil',
    ],
